...
export default function WelfareRequestsPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.employeeName || !formData.welfareType) {
      alert("من فضلك أدخلي الاسم ونوع الرعاية.");
      return;
    }
    ...
    try {
      const { data, error } = await supabase
        ...
        .insert({
          ...
          welfare_type: formData.welfareType,
    ...
    <div>
      <div style={styles.card}>
        <div style={styles.cardHeader}>
          <div>
            <h2 style={styles.cardTitle}>🤲 طلبات الرعاية الاجتماعية</h2>
            <p style={styles.cardSub}>
              إدارة طلبات الرعاية الصحية والاجتماعية
            </p>
          </div>
          <button
            ...
            <table style={styles.table}>
              <thead>
                <tr>
                  ...
                  <th style={styles.th}>نوع الرعاية</th>
              ...
              <tbody>
                {requests.map((request) => (
                  <tr key={request.id} style={styles.tr}>
                    ...
                    <td style={styles.td}>{request.welfare_type || "—"}</td>
                    <td style={styles.td}>
      ...
      {showForm && (
        ...
        >
          ...
          >
            ...
            <h2 style={styles.loginTitle}>إضافة طلب رعاية</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, welfareType: e.target.value })
                }
                style={styles.input}
                required
              />
