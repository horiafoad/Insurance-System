...
export default function FellowshipRequestsPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.employeeName || !formData.fellowshipType) {
      alert("من فضلك أدخلي الاسم ونوع الزمالة.");
      return;
    }
    ...
    try {
      const { data, error } = await supabase
        ...
        .insert({
          ...
          fellowship_type: formData.fellowshipType,
    ...
    <div>
      <div style={styles.card}>
        <div style={styles.cardHeader}>
          <div>
            <h2 style={styles.cardTitle}>🎓 طلبات الزمالة</h2>
            <p style={styles.cardSub}>
              إدارة طلبات الزمالة والاشتراكات
            </p>
          </div>
          <button
            ...
            <table style={styles.table}>
              <thead>
                <tr>
                  ...
                  <th style={styles.th}>نوع الزمالة</th>
              ...
              <tbody>
                {requests.map((request) => (
                  <tr key={request.id} style={styles.tr}>
                    ...
                    <td style={styles.td}>{request.fellowship_type || "—"}</td>
                    <td style={styles.td}>
      ...
      {showForm && (
        ...
        >
          ...
          >
            ...
            <h2 style={styles.loginTitle}>إضافة طلب زمالة</h2>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <input
                type="text"
                placeholder="نوع الزمالة"
                value={formData.fellowshipType}
                onChange={(e) =>
                  setFormData({ ...formData, fellowshipType: e.target.value })
                }
                style={styles.input}
                required
              />
