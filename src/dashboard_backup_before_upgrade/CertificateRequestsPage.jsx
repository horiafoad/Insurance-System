...
export default function CertificateRequestsPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.employeeName || !formData.certificateType) {
      alert("من فضلك أدخلي الاسم ونوع الإفادة.");
      return;
    }
        ...
        <div style={styles.cardHeader}>
          <div>
            ...
            <p style={styles.cardSub}>
              إدارة طلبات استخراج الإفادات والمستندات
            </p>
          </div>
          <button
      ...
      {showForm && (
        ...
        >
          ...
          >
            ...
            <h2 style={styles.loginTitle}>إضافة طلب إفادة</h2>
